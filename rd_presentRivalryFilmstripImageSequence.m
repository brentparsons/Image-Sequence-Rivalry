function [responseTimes responseKeyboardEvents responseAcc] = ...
    rd_presentRivalryFilmstripImageSequence(window, texs, imageDuration, trialDuration, imageSequenceCategories, categoryNames, categoryKeyNumbers, devNums, correctsound, errorsound)
